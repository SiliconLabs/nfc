 ...
 * Check https://www.bluetooth.com/specifications/assigned-numbers/generic-access-profile/ for all values.
 */
...
typedef struct {
  ...
  bt_le_optional_ad_t secure_connectinos_random_value;
