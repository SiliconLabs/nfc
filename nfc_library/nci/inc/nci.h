 ...
 * ----------
 * @brief Enum to hold values for all non proprietary NCI NFCEE Protocols/Interfaces.
 ...
 * ----------
 * @brief Enum to hold values for all NCI NFCEE Management Opcode Identifier (OID).
 *        See NCI 1.0 spec table 102.
 */
typedef enum {
