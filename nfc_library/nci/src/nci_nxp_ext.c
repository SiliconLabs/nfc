...
static void nci_proprietary_nxp_act_rsp_process (uint8_t* packet_buff) {
    ...
    nci_evt->data.payload.proprietary_data.proprietary_nxp_act_rsp.status = packet_buff[index++];
    nci_evt->data.payload.proprietary_data.proprietary_nxp_act_rsp.fw_build_num = &packet_buff[index];
}
