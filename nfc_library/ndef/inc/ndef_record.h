...
#define NDEF_RECORD_HEADER_MB_M                         (0x01 << NDEF_RECORD_HEADER_MB_SHIFT)
#define NDEF_RECORD_HEADER_ME_SHIFT                     (6)
#define NDEF_RECORD_HEADER_ME_M                         (0x01 << NDEF_RECORD_HEADER_ME_SHIFT)
#define NDEF_RECORD_HEADER_CF_SHIFT                     (5)
#define NDEF_RECORD_HEADER_CF_M                         (0x01 << NDEF_RECORD_HEADER_CF_SHIFT)
#define NDEF_RECORD_HEADER_SR_SHIFT                     (4)
#define NDEF_RECORD_HEADER_SR_M                         (0x01 << NDEF_RECORD_HEADER_SR_SHIFT)
#define NDEF_RECORD_HEADER_IL_SHIFT                     (3)
#define NDEF_RECORD_HEADER_IL_M                         (0x01 << NDEF_RECORD_HEADER_IL_SHIFT)
#define NDEF_RECORD_HEADER_TNF_SHIFT                    (0)
#define NDEF_RECORD_HEADER_TNF_M                        (0x07 << NDEF_RECORD_HEADER_TNF_SHIFT)
